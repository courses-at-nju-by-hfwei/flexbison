...
#line 1390 "fb3-2.tab.c"
    break;

  case 8:
#line 59 "fb3-2.y"
                          { (yyval.a) = newcmp((yyvsp[-1].fn), (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1396 "fb3-2.tab.c"
    break;

  case 9:
#line 60 "fb3-2.y"
                          { (yyval.a) = newast('+', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1402 "fb3-2.tab.c"
    break;

  case 10:
#line 61 "fb3-2.y"
                          { (yyval.a) = newast('-', (yyvsp[-2].a),(yyvsp[0].a));}
#line 1408 "fb3-2.tab.c"
    break;

  case 11:
#line 62 "fb3-2.y"
                          { (yyval.a) = newast('*', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1414 "fb3-2.tab.c"
    break;

  case 12:
#line 63 "fb3-2.y"
                          { (yyval.a) = newast('/', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1420 "fb3-2.tab.c"
    break;

  case 13:
#line 64 "fb3-2.y"
                          { (yyval.a) = newast('|', (yyvsp[0].a), NULL); }
#line 1426 "fb3-2.tab.c"
    break;

  case 14:
#line 65 "fb3-2.y"
                          { (yyval.a) = (yyvsp[-1].a); }
#line 1432 "fb3-2.tab.c"
    break;

  case 15:
#line 66 "fb3-2.y"
                          { (yyval.a) = newast('M', (yyvsp[0].a), NULL); }
#line 1438 "fb3-2.tab.c"
    break;

  case 16:
#line 67 "fb3-2.y"
                          { (yyval.a) = newnum((yyvsp[0].d)); }
#line 1444 "fb3-2.tab.c"
    break;

  case 17:
#line 68 "fb3-2.y"
                          { (yyval.a) = newfunc((yyvsp[-3].fn), (yyvsp[-1].a)); }
#line 1450 "fb3-2.tab.c"
    break;

  case 18:
#line 69 "fb3-2.y"
                          { (yyval.a) = newref((yyvsp[0].s)); }
#line 1456 "fb3-2.tab.c"
    break;

  case 19:
#line 70 "fb3-2.y"
                          { (yyval.a) = newasgn((yyvsp[-2].s), (yyvsp[0].a)); }
#line 1462 "fb3-2.tab.c"
    break;

  case 20:
#line 71 "fb3-2.y"
                          { (yyval.a) = newcall((yyvsp[-3].s), (yyvsp[-1].a)); }
#line 1468 "fb3-2.tab.c"
    break;

  case 22:
#line 75 "fb3-2.y"
                    { (yyval.a) = newast('L', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1474 "fb3-2.tab.c"
    break;

  case 23:
#line 77 "fb3-2.y"
                    { (yyval.sl) = newsymlist((yyvsp[0].s), NULL); }
#line 1480 "fb3-2.tab.c"
    break;

  case 24:
#line 78 "fb3-2.y"
                    { (yyval.sl) = newsymlist((yyvsp[-2].s), (yyvsp[0].sl)); }
#line 1486 "fb3-2.tab.c"
    break;
...
#line 87 "fb3-2.y"
                       ...
                       printf("Defined %s\n> ", (yyvsp[-6].s)->name); }
#line 1504 "fb3-2.tab.c"
    break;

  case 28:
#line 91 "fb3-2.y"
                       { yyerrok; printf("> "); }
#line 1510 "fb3-2.tab.c"
    break;


#line 1514 "fb3-2.tab.c"
